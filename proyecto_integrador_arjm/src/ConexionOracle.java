//Patron Singlenton: Limita la creacion de instancias de un determinado tipo a solo una instancia
// que sera la unica a alo largo de todo el sistema
//Garantiza el estado del objeto donde sea que lo llame
...
private static ConexionOracle instancia = new ConexionOracle(); //Objeto
private Connection connection; //Objecto de la clase Connection
...
//Dentro del objeto ConexionOracle(instancia) se accede a esta
