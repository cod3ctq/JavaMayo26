...
public class Constantes {
    ...
    public static final String MAX_DAILY_WITHDRAWAL_EXCEEDED = "Retiro no disponible, se ha superado la cantidad diaria de retiro";
    ...
    public static final String UNDER_MINIMUM = "Retriro no disponible. Excede el minimo permitido";
