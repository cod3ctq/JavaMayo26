...
//        System.out.println(videojuego1+"\n"+videojuego2);
        ...
        Smartphone sm = new Smartphone("Nokia N958GB", "NOKIA", 8000.0, 1200, "Symbian s60v3", cams);

        Smartphone sm2 = new Smartphone("Samsung S25 Ultra", "Samsung", 26000.0, 5000, "Android 17", camSamsung);
