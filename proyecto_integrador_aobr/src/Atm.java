...
public abstract class Atm {
    ...
    private List<CuentaDTO> cacheCuentas; //objeto que contiene las cuentas tal como vienen desde la bd
    ...
    public Atm(){
        ...
        this.cacheCuentas = cuentadao.leerCuentas(); //llena automaticamente el cache trayendo las cuentas desde la bd
    }
    ...
    //throw: dentro de la logica del metodo, crea o instancia la excepcion
