...
public class ServiciosDAO {
    ...
    //Este metodo consume un STORED PROCEDURE: En este caso, la logica de negocio fue programada al interior
    //del stored procedure , y aqui solo se invoca su ejecucion
