...
public class MovimientoDAO {
    ...
    public ReporteMovsDTO generarReporteMovimientosPorCliente(String cliente, String fechaInicio, String fechaFin){
        ...
        //ESTOS 2 DATOS SE REPITEN A LO LARGO DE TODO EL RESULT SET
        String titular =""; //NOMBRE COMPLETO DEL CLIENTE
        String rfc = ""; //RFC
        //MAPA QUE GUARDARA LOS DETALLES ASOCIADOS A CADA CUENTA INDIVIDUAL [1000003:NOMINA ---> [0, 0, 0, 0, 0]]
        Map<String, List<DetalleMovimientoDTO>> movs = new HashMap<String, List<DetalleMovimientoDTO>>();
        //Objeto auxiliar para extraer y guardar los datos de cada movimiento [O]
        DetalleMovimientoDTO detalle;
        //Variables que guardan los calculos de ingresos y egresos
        double ingresos=0.0;
        double egresos=0.0;
        ...
        try{
            ...
            while(rs.next()){
                //llave: 10000000001:AHORRO BASICA
                ...
                if(movs.containsKey(llave)){
                    movs.get(llave).add(detalle); //se aniade el objeto a la lista
                }else{
                    //sino, seguramente es la primera vez que se encuentra esa combinacion de numCuenta + descripcion
                    //entonces se aniade la llave al mapa (junto con su lista) y se agrega el primer detalle a esa lista
