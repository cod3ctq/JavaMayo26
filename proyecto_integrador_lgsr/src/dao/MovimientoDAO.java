...
public class MovimientoDAO {
    ...
    public void registrarMovimiento(int cuentaId, String operacion, double monto) {
        ...
        try {
            ...
            System.out.println(">>>>>>>>>>LLAMADA A LA BASE DE DATOS Y:" + con);
    ...
    public ReporteMovsDTO generarReporteMovimientosPorCliente(String cliente, String fechaInicio, String fechaFin) {
        ...
        try {
            ...
            while (rs.next()) {
                //llave: 100000000001: AHORRO BASICA
                ...
                if (movs.containsKey(llave)){
                    movs.get(llave).add(detalle); //se anade el objeto a la lista
                }else{
                    //si no, seguramente es la primera vez que se encuentra esa combinacion de numCuenta + DESCRIPCION
                    //entonces se anade la llave al mapa(junto con su lista) y se agrega el primer detalle a esa lista
            ...
            //Ya con todos los detalles collectados en las listas del mapa, se concreta el objeto global
