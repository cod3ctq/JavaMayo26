...
public class ConexionOracle {
    ...
    private String driver = OracleProvider.DRIVER; // Asignamos los valores de las constantes definidas en la Clase OracleProvider
    ...
    // Dentro del Objeto ConexionOracle(instancia) se accede a esta conexión configurada con los datos anteriores
