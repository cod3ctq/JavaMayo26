...
Garantiza el estado de objeto donde sea que se lo llame
*/
public class ConexionOracle {
    ...
    /*Constructor privado: Unico lugar donde instancia el objeto de esta clase, al ser privano no aacederse
    o invocarse en ningun otro lado fuera de la clase */
    ...
    //Metodo estatico a traves del cual obtendremos acceso siempre a la unica instancia de la conexion
    public static ConexionOracle getInstance(){

        return instancia;
    }
    //Dentro del objeto database.ConexionOracle(instancia) se accede a esta conexion configurada con los datos anteriores
