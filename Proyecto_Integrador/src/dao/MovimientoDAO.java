...
public class MovimientoDAO {
    ...
    public ReporteMovsDTO generarReporteMovimientosPorCliente(String cliente, String fechaInicio, String fechaFin) throws SQLException {
        ...
        String rfc = ""; //rfc
        //Mapa que guardara los detalles asociados a cada cuenta individual [10000003:NOMINA -> [0,0,0,0]]
        Map<String, List<DetalleMovimientoDTO>> movs = new HashMap<String, List<DetalleMovimientoDTO>>();
        //Objeto auxiliar para extraer y guardar los datos de cada movimiento [0]
        DetalleMovimientoDTO detalle;
        //Variables que guardaran los totales de ingresos y egresos
        double ingresos = 0.0;
        double egresos = 0.0;
