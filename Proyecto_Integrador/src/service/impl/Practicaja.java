...
public class Practicaja extends Atm implements IOperacionesBasicas, IOperacionesAvanzadas {
    ...
    @Override
    public Ticket cobrarRetiroSinTarjeta() throws InvalidCardNumberException, WithdrawalAlreadyRecievedException{
        ...
        if (!existe){
            ...
            throw new WithdrawalAlreadyRecievedException(Constantes.WITHDRAWAL_ALREADY_RECEIVED);
        }else{
