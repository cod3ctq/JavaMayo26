public class CajaCobro {
    ...
    //Atributos de la clase (reciben su valor desde la clase y son compartidos por todas las instancias)

    public static double ventaTotal = 0.0;
    public static int numVentas = 0;


    //Atributos de instancia: casa instancia decide el valor de estos atributos
