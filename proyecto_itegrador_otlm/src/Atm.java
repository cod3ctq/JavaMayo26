...
public abstract class Atm {
    ...
    //throws : Va en la forma del metodo y propaga la excepcion
    ...
    private Cuenta[] cargarCuentas(){
        File file = new File("C:\\Users\\VIOM2\\Desktop\\cuentas.txt");
        String linea;//Informacion completa, linea por linea
        Cuenta cuenta;//Objeto temporal que guardara cada linea
